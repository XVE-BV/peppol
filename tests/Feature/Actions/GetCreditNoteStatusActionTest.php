...
it('gets credit note status successfully', function (): void {
    Http::fake([
    ...
    $action = app(GetCreditNoteStatusAction::class);
...
it('gets credit note status with numeric id', function (): void {
    Http::fake([
...
it('handles different credit note statuses', function (string $status): void {
    Http::fake([
        'api.example.com/api/invoices/123/status' => Http::response([
            'invoice' => [
                'id' => 123,
